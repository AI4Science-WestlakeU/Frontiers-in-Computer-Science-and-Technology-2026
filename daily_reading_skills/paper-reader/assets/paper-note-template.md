...
- **作者列表**: {核心作者}
- **机构列表**: {核心机构}
- **合作形态**: {单组深耕 / 跨机构合作 / 工程+应用合作}
- **角色判断**: {谁更像方法核心推进者，谁更像应用/资源提供方}

### 直接证据

- {作者/机构1}: {为什么能说明他们就在做这个方向}
- {作者/机构2}: {对应证据}
...
- **{作者A}** ({机构}): {问题/方法重合点}；代表论文：{paper/project}
- **{作者B}** ({机构}): {问题/方法重合点}；代表论文：{paper/project}
