...
description: |
  在读完/总结完一篇论文后，或基于当前已有的一组论文笔记，
  分析这个方向有哪些核心作者、实验室和机构在做。用户说“作者机构分析”、
  “这个方向谁在做”、“这篇论文背后有哪些组”、“帮我摸一下这个领域的人/机构”、
  “读完后顺手分析作者和机构”、“分析一下现在有的论文的作者与机构图谱”、
  “汇总现有论文的人和机构”时使用。

  它是单篇分析和多篇汇总的统一入口：可与 paper-reader 联用，
  先总结论文，再输出“作者与机构图谱 / 值得跟踪的人和组”；
  也支持扫描当前笔记库，做跨论文作者 / 机构总览，并可回填到现有笔记。
---
